...
function validarCampos() {
    ...
    !nuevaContrasenia.value.trim() || !regContrasenia.test(confirmarContrasenia.value) || !confirmarContrasenia.value.trim() || nuevaContrasenia.value != confirmarContrasenia) {
        return false;
    } else {
        return true;
    }
